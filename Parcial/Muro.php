...
<html>
  ...
  <body>
        ...
        ?>
                ...
                <div>
                    <img src="perfiles/<?php echo $m->getRemitente()->getNombreUsuario();?>.jpg" class="imagenPerfil moverImagenPerfil">
			<div class="muroContenedor">
				<div class="NombreDelUsuario">
					<?php echo $m->getRemitente()->getNombre();?> &raquo;
                            ...
                            <div class="respuestas ">
                                ...
                                ?>
                                <div class="respuesta">
                                    <img src="perfiles/<?php echo $r->getRemitente()->getNombreUsuario();?>.jpg" class="imagenPerfil moverImagenPerfil">
                                    <div class="muroContenedor">
                                        <div class="NombreDelUsuario">
